  ...
  <table id="adminTable" class="table table-bordered table-striped">
            ...
            <td>
                    <button class="btn btn-sm btn-info">
                        <a href="/nghesy/${item.id_ns}" style="color: white;">Chọn </a>
                    </button>
                </td>
                            </tr>
                        </c:forEach>
