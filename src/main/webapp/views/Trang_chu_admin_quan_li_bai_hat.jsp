...
<head>
    ...
    <script>
        function resetForm() {
            document.getElementById("baiHatForm").reset();
        }

        function editBaiHat(id) {
            // Lấy dữ liệu bài hát từ bảng và điền vào form
            // Đây là nơi bạn sẽ viết mã để lấy dữ liệu và điền vào form
        }

        function deleteBaiHat(id) {
            // Thực hiện xóa bài hát với ID tương ứng
            // Đây là nơi bạn sẽ viết mã để xóa bài hát
        }
    </script>
</head>
<body>
    <div class="content">
        <nav class="navbar navbar-expand-lg navbar-light">
            <a class="navbar-brand" href="/admin">Quản lý người dùng</a>
        ...
        <div class="container mt-5">
            <jsp:include page="form_quanly_baihat.jsp"/>
            <div class="table-container p-4 bg-white">
                ...
                <h2 class="mb-3 text-center">Danh Sách Quản lý bài hát</h2>
                      <jsp:include page="table_quanly_baihat.jsp"/>
            </div>
        </div>
    </div>
</body>
