...
<head>
    ...
    <script>
        ...
        function editNguoiDung(id) {
            // Lấy dữ liệu người dùng từ bảng và điền vào form
            // Đây là nơi bạn sẽ viết mã để lấy dữ liệu và điền vào form
        }

        function deleteNguoiDung(id) {
            // Thực hiện xóa người dùng với ID tương ứng
            // Đây là nơi bạn sẽ viết mã để xóa người dùng
        }
    </script>
</head>
<body>
    <div class="content">
        ...
        <div class="container mt-5">
         <jsp:include page="form_quanly_nguoidung.jsp"/>
            ...
            <div class="table-container p-4 bg-white">
                ...
                <h2 class="mb-3 text-center">Danh Sách Quản lý người dùng</h2>
                        <jsp:include page="table_quanly_nguoidung.jsp"/>
            </div>
        </div>
    </div>
</body>
