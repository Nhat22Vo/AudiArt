...
<table class="table table-bordered table-striped">
    ...
    <c:forEach var="item" items="${items}">
        <tr>
            ...
            <td><c:out value="${item.ma_vi}"/></td> <!-- Mã Ví -->
            <td><c:out value="${item.privateKey}"/></td> <!-- Private Key -->
            ...
            <td>
                <button class="btn btn-sm btn-info">
                    <a href="/nguoidung/${item.id_nd}" style="color: white;">Chọn </a>
                </button>
            </td>
        </tr>
    </c:forEach>
